...
namespace MediaBazaar
{
    public partial class Form1 : Form
    {
        ...
        {
            FormEmployees formManageEmployees = new FormEmployees(this.empAdmin, managerLoggedIn, prodAdmin);
        ...
        {
            FormStatistics formStatistics = new FormStatistics(this.empAdmin, this.managerLoggedIn, this.prodAdmin);
