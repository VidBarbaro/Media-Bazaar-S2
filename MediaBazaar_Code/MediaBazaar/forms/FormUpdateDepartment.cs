            ...
            if (this.tbName.Text != this.d.Name || this.tbPersonel.Text != this.d.RequiredPersonel.ToString())
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            DatabaseHelper.UpdateExistingEmployee(emp.Id, emp.Name, emp.Password, emp.Email, emp.Gender, emp.PhoneNumber, emp.Address, emp.HourlyWage, emp.HoursWorked, emp.BirthDate, emp.HolidayDays, emp.SickDays, tbName.Text);
                        }
