...
namespace MediaBazaar.forms
{
    public partial class FormAssignEmployees : Form
    {
        ...
        private void btnAssign_Click(object sender, EventArgs e)
        {
            ...
            DatabaseHelper.UpdateExistingEmployee(emp.Id, emp.Name, emp.Password, emp.Email, emp.Gender, emp.PhoneNumber, emp.Address, emp.HourlyWage, emp.HoursWorked, emp.BirthDate, emp.HolidayDays, emp.SickDays, dep.Name);
