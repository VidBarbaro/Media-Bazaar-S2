    ...
    public partial class FormAddEmployee : Form
    {
        ...
        private void btnAddEmployee_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    DatabaseHelper.AddNewUser(name, email, gender.ToString(), (float)hourlyWage, address, phoneNumber, (float)hoursWorked, password, holidayDays, sickDays, birthDate, department);
