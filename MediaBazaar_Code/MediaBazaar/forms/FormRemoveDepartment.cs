    ...
    public partial class FormRemoveDepartment : Form
    {
        ...
        private void btnDeleteDepartment_Click(object sender, EventArgs e)
        {
            ...
            if(DatabaseHelper.DeleteExistingDepartment(d.Name, d.RequiredPersonel) == true)
            {
                ...
                {
                    DatabaseHelper.UpdateExistingEmployee(emp.Id, emp.Name, emp.Password, emp.Email, emp.Gender, emp.PhoneNumber, emp.Address, emp.HourlyWage, emp.HoursWorked, emp.BirthDate, emp.HolidayDays, emp.SickDays, "UNASSIGNED");
                }
