...
namespace MediaBazaar
{
    class DatabaseHelper
    {
        ...
        public static void AddNewUser(string username, string email, String gender, double hourlyWage, string address, string phoneNumber, double hoursWorked, string password, int holidayDays, int sickDays, DateTime birthDate, String department)
        {
            ...
            try
            {
                ...
                string sql = "INSERT INTO users(username,email,gender,hourlyWage,address,phoneNumber,hoursWorked,password,holidayDays,sickDays,birthDate, department) " +
                    "VALUES(@username,@email,@gender,@hourlyWage,@address,@phoneNumber,@hoursWorked,@password,@holidayDays,@sickDays,@birthDate, @department)";
        ...
        public static void UpdateExistingEmployee(int id, string username, string password, string email, String gender,
            string phoneNumber, string address, double hourlyWage, double hoursWorked, DateTime birthDate, int holidayDays, int sickDays, String department)
        {
            MySqlConnection conn = null;
            try
            {
                ...
                string sql = "UPDATE users SET username = @username, email = @email, holidayDays = @holidayDays, sickDays = @sickDays, birthDate = @birthDate, " +
                    "gender = @gender, hourlyWage = @hourlyWage, address = @address, phoneNumber = @phoneNumber, hoursWorked = @hoursWorked, password = @password, department = @department WHERE id = @id";
                MySqlCommand cmd = new MySqlCommand(sql, conn);
        ...
        public static List<Employee> GetAllEmployees()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    employees.Add(new Employee(id, name, password, email, gender, phoneNumber, address, hourlyWage, hoursWorked, birthDate, holidayDays, sickDays, department));
                }
            }
            catch (MySqlException ex)
            {
        ...
        public static void AddShift(String name, String email, DateTime date, String shift)
        {
            ...
            {
                conn = new MySqlConnection(CONNECTION_STRING);
                string sql = "INSERT INTO shifts(name, email, date, shift) " +
                    "VALUES(@name, @email, @date, @shift)";
                MySqlCommand cmd = new MySqlCommand(sql, conn);
                cmd.Parameters.AddWithValue("@name", name);
                cmd.Parameters.AddWithValue("@email", email);
                cmd.Parameters.AddWithValue("@date", date);
        ...
        public static bool DeleteExistingShift(int id, String name, String email, DateTime date, String shift)
        {
            MySqlConnection conn = null;
            try
            {
        ...
        public static bool UpdateExistingShift(int id, String name, String email, DateTime date, String shift)
        {
            MySqlConnection conn = null;
            try
            {
                conn = new MySqlConnection(CONNECTION_STRING);
                string sql = "UPDATE shifts SET id = @id, name = @name, email = @email, date = @date, shift = @shift WHERE id = @id";
                MySqlCommand cmd = new MySqlCommand(sql, conn);
                cmd.Parameters.AddWithValue("@id", id);
                cmd.Parameters.AddWithValue("@name", name);
                cmd.Parameters.AddWithValue("@email", email);
