    ...
    $calendar.= "<a class='btn btn-xs btn-primary' href='?month=".date('m', mktime(0, 0, 0, $month+1, 1, $year))."&year=".date('Y', mktime(0, 0, 0, $month+1, 1, $year))."'>Next Month</a></center><br>";
     ...
     while ($currentDay <= $numberDays) {
         ...
         if($date<date('Y-m-d')){
            ...
            $calendar.="<td class='$today'><h4>$currentDay</h4> <a href='request.php?date=".$date."' class='btn btn-danger btn-xs'>Scheduled</a>";
        }else{
             $calendar.="<td class='$today'><h4>$currentDay</h4> <button class='btn btn-success btn-xs'>Free</button>";
         }
