                ...
                <div class="lower-container">
                    <form action="../includes/edit-profile-user.inc.php" method="post">
                        <div>
                            ...
                            <h4>Phone Number:</h3>
                            <br>
                            <input type="text" name="currentPhoneNumber" value="<?php echo $phoneNr;?>">
                            <br><br>
                            <h4>Address:</h3>
                            <br>
                            <input type="text" name="currentAddress" value="<?php echo $address;?>">
                            <br><br>
                            <input type="submit" name="submit" value="Edit Profile" class="btn"></a>
                        </div>
                    </form>
                </div>
