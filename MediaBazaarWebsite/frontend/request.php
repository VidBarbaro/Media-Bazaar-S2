...
if(isset($_POST['submit_shiftoff'])){
    ...
    else{$message_shift = "<p style=color:red;>Please provide a reason for your shift request.<p>";}
    ...
    else{$message_sick = "<p style=color:red;>Please provide a reason for your sickday request.<p>";}
...
<html lang="en">
  ...
  <body>
    <div class="container">
        <button class="btn btn-secondary"><a href="calendar.php">Back to schedule</a></button>
            ...
            <div class="col-md-6 col-md-offset-3">
               <?php echo isset($msg)?$msg:''; ?>
                <form action="" method="post" autocomplete="off">
                    ...
                    <button class="btn btn-primary" type="submit" name="submit_shiftoff">Request Shift Off</button>
                ...
                <form action="" method="post" autocomplete="off">
                    ...
                    <button class="btn btn-primary" type="submit" name="submit_sickday">Request this day as a SICKDAY</button>
                <br><br>
