...
<body>
  <header>
    ...
    <ul class="navigation">
      ...
      <!-- <li>
        <a href="employee-management.php" onclick="toggleMenu();">Employees</a>
      </li>
      <li>
        <a href="inventoryManagement.php" onclick="toggleMenu();">Inventory</a>
      </li> -->
      ...
      <li>
        <a href="statistics.php" onclick="toggleMenu();">Statistics</a>
      </li>
      <li>
